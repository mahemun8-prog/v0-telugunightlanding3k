          ...
          const handleFirstInteraction = async () => {
            if (audioRef.current) {
              try {
                ...
                console.log("Failed to play audio on interaction:", e)
              }
            }
          }
            ...
            <div className="mb-6 sm:mb-8 md:mb-12 lg:mb-16 py-[101px]">
              ...
              >
                ...
                <div className="absolute inset-0 z-0 overflow-hidden">
                  ...
                  >
                    <source
                      src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/WhatsApp%20Video%202025-09-08%20at%2016.34.59_b9b85147-w2EeUwygSRRRH6zMCteexrwdGzEYOR.mp4"
                      type="video/mp4"
                    />
                  </video>
                ...
                <div className="relative z-10 h-full flex flex-col items-center justify-center p-8 sm:p-10 md:p-12 lg:p-16 xl:p-20">
                  ...
                  <button
                    ...
                    className="mb-4 sm:mb-6 md:mb-8 px-6 sm:px-8 md:px-10 py-3 sm:py-4 md:py-5 text-sm sm:text-base md:text-lg font-bold rounded-lg sm:rounded-xl transition-all duration-200 hover:scale-105 active:scale-95 touch-manipulation shadow-2xl"
                    style={{
                      background: "linear-gradient(135deg, #14b8a6 0%, #0891b2 100%)",
                      color: "white",
                      textShadow: "0 2px 4px rgba(0, 0, 0, 0.3)",
                      boxShadow: "0 0 30px rgba(20, 184, 166, 0.4), 0 8px 16px rgba(0, 0, 0, 0.3)",
                    }}
                  >
                    🎫 Book Now 🎫
                  </button>
                ...
                <AnimatedSection key={title} animation="fadeUp" delay={index * 25}>
                  <Card className="bg-zinc-900/60 backdrop-blur-sm border border-zinc-800/80 hover:border-zinc-700/80 transition-colors duration-200 shadow-2xl rounded-lg sm:rounded-xl group h-full">
                    <CardContent className="p-4 sm:p-6 md:p-8 text-center h-full flex flex-col">
                      <div className="bg-zinc-800/60 p-3 sm:p-4 rounded-full w-fit mx-auto mb-4 sm:mb-6 md:mb-8 group-hover:bg-zinc-700/60 transition-colors duration-200 flex-shrink-0">
